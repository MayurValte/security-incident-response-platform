 ...
 * this service's UserClient propagating trace context and creating
 * client spans. Declaring it as a top-level @Bean applies it to every
 * Feign client in this service.
 */
@Configuration
