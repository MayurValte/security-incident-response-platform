...
public class KafkaErrorHandlingConfig {
    ...
    public DefaultErrorHandler kafkaErrorHandler(KafkaTemplate<Object, Object> kafkaTemplate) {
        ...
        // notification-service and audit-service - a shared .DLT topic
     ...
     * Spring Boot's listener container factory configurer picks up a
     * single RecordInterceptor bean automatically.
     */
    @Bean
